...
const VIA_CSS = `
  .via-label { text-align: center; font-weight: 600; border: 1px solid #cbd5e1; border-radius: 6px; padding: 2px 6px; margin: 0 2mm 4px; font-size: 8pt; letter-spacing: 1.2px; color: #000; text-transform: uppercase; }
  .via-wrap { width: 100%; }
...
const GR_CSS = `
  ...
  * { box-sizing: border-box; }
  ...
  .svc-head { display: flex; font-size: 6.5pt; letter-spacing: 1px; text-transform: uppercase; color: #000; padding-bottom: 1mm; border-bottom: 1px solid #e2e8f0; }
