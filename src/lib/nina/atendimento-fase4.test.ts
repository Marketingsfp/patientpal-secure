...
describe("fase 4 — dados mínimos", () => {
  it("aponta o que falta antes de consultar a agenda", () => {
    expect(faltaParaConsultarAgenda(estadoFluxoVazio())).toContain("procedimento");
    expect(faltaParaConsultarAgenda(estadoFluxoVazio())).toContain("preferencia_data");
  });
