/**
 * MATERIAL FIXO DE TESTE — Prompt Principal PUBLICADO do WhatsApp (versão 15,
 * id e8ecc58b-7186-42ce-8e3f-a90c42c25c1a, publicado em 2026-09-13).
 *
 * Cópia literal usada APENAS para reproduzir, em teste, a classificação real
 * do motor de confiabilidade. Não é fonte de comportamento: o runtime continua
 * lendo a versão publicada no banco.
 */
export const PROMPT_PUBLICADO_V15 = `[IDENTIDADE DO ATENDIMENTO]
...
- Informações administrativas e preparo: catálogo/base oficial publicados.
- Vagas e agendamentos: agenda atual.
