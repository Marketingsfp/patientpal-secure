/**
 * Textos e ferramentas do treino (roleplay) enviados à IA.
 *
 * Ficavam dentro das funções chamadas pelo navegador. Agora o treino inteiro é
 * conduzido pelo servidor (ver `sessao.functions.ts`) e este arquivo guarda só
...
export type Msg = { role: "cliente" | "atendente"; content: string };
...
/** Mensagens da chamada que cria o cenário do treino. */
...
/** Mensagens de cada turno do treino, já com o histórico recortado. */
