...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      {/* Em português: esta é a tela que aparece quando todo o resto falhou, e
          quem a lê é a recepção ou o médico no meio do atendimento. Era a única
          tela do sistema em inglês. */}
      <div className="max-w-md text-center">
        <h1 className="text-xl font-semibold tracking-tight text-foreground">
          Esta página não carregou
        </h1>
        <p className="mt-2 text-sm text-muted-foreground">
          Algo falhou do nosso lado. Tente novamente — se o problema continuar, volte ao início e
          avise o suporte.
        </p>
