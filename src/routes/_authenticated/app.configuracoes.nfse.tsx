        ...
        columns={[
          {
            key: "nome",
            header: "Nome",
            render: (r) => <span className="font-semibold text-sm">{r.nome}</span>,
          },
          {
            key: "cnpj",
            header: "CNPJ",
            className: "w-44",
            render: (r) => <span className="font-mono text-xs text-foreground">{r.cnpj}</span>,
          },
          {
            key: "mun",
            header: "Município",
            render: (r) => (
              <span className="text-sm text-muted-foreground">{`${r.municipio}/${r.uf}`}</span>
            ),
          },
          {
            key: "iss",
            ...
            render: (r) => (
              <span className="font-mono text-xs text-foreground">{`${(Number(r.aliquota_iss) * 100).toFixed(2)}%`}</span>
            ),
          },
          {
            key: "amb",
