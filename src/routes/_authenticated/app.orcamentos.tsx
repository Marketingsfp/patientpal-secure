                  ...
                  <td className="px-3 py-2 font-medium">
                    <div className="flex items-center gap-2">
                      ...
                      {o.categoria === "laboratorio" ? (
                        <span className="text-[10px] font-semibold px-1.5 py-0.5 rounded bg-blue-500/15 text-blue-700 dark:text-blue-300 uppercase">
                          Laboratório
                        </span>
                      ) : o.categoria === "demais" ? (
                      ...
                      <Button
                        ...
                        onClick={() => {
                          ...
                          if (isEmbed && window.parent && window.parent !== window) {
                            ...
                            navigate({
                              to: "/app/orcamentos-agenda",
                              search: { orc: numero } as never,
                            });
                          }
                        }}
                ...
                {itens.some((i) => i.preparo && i.preparo.trim()) && (
                  <div className="bg-amber-50 dark:bg-amber-950/30 border-b border-amber-200 dark:border-amber-900 px-3 py-2 space-y-1">
                    <div className="flex items-center gap-2 text-sm font-semibold text-amber-800 dark:text-amber-200">
                      <AlertTriangle className="h-4 w-4" /> Atenção: este orçamento contém exame(s)
                      com preparo
                    </div>
