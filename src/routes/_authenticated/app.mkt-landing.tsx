  ...
  return (
    <SimpleCrud<Row, Form>
      ...
      columns={[
        {
          key: "titulo",
          header: "Título",
          render: (r) => <span className="font-medium">{r.titulo}</span>,
        },
        {
          key: "slug",
          header: "URL",
        ...
        },
        {
          ...
          render: (r) => (
            <span
              className={`text-xs px-2 py-0.5 rounded-full capitalize ${r.status === "publicada" ? "bg-emerald-100 text-emerald-700" : "bg-muted text-muted-foreground"}`}
            >
              {r.status}
            </span>
          ),
      ...
      toForm={(r) => ({
        ...
        cor_primaria: r.cor_primaria ?? "#0f172a",
        cta_label: r.cta_label ?? "Quero saber mais",
        status: r.status,
        conteudo_html: r.conteudo_html ?? "",
        hero_imagem_url: r.hero_imagem_url ?? "",
      })}
      toPayload={(f) => ({
        slug: f.slug
          .trim()
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <Input
                required
                value={f.titulo}
                onChange={(e) => set({ ...f, titulo: e.target.value })}
              />
            </div>
            <div className="space-y-1">
...
<<<<<<< HEAD
          <div className="grid grid-cols-3 gap-3">
            <div className="space-y-1">
              ...
              <Input
                type="color"
                value={f.cor_primaria}
                onChange={(e) => set({ ...f, cor_primaria: e.target.value })}
              />
            </div>
...
>>>>>>> 18eb686dbc25b258ff35f41366dbb0c3660f374b
          ...
          <div className="space-y-1">
            ...
            <Input
              value={f.hero_imagem_url}
              onChange={(e) => set({ ...f, hero_imagem_url: e.target.value })}
              placeholder="https://..."
            />
          </div>
          <div className="space-y-1">
            ...
            <Textarea
              rows={5}
              value={f.conteudo_html}
              onChange={(e) => set({ ...f, conteudo_html: e.target.value })}
              placeholder="<p>Descreva sua oferta...</p>"
            />
          </div>
          <div className="space-y-1">
            <Label>Status</Label>
