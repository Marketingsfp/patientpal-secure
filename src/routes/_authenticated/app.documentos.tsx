...
function DocumentosPage() {
  ...
  const [modelos, setModelos] = useState<
    { id: string; nome: string; tipo: Tipo; conteudo: string }[]
  >([]);
            ...
            <Select
              ...
              onValueChange={(v) => {
                ...
                set({
                  ...
                  modelo_id: v || null,
                  tipo: md?.tipo ?? f.tipo,
                  conteudo: md?.conteudo ?? f.conteudo,
                  titulo: f.titulo || (md?.nome ?? ""),
                });
              }}
            >
              <SelectTrigger>
...
>>>>>>> 18eb686dbc25b258ff35f41366dbb0c3660f374b
          ...
          <label className="flex items-center gap-2 text-sm">
            <Checkbox checked={f.assinado} onCheckedChange={(v) => set({ ...f, assinado: !!v })} />{" "}
