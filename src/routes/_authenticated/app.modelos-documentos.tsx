...
interface Row { id: string; nome: string; tipo: Tipo; conteudo: string; ativo: boolean; }
    ...
    <SimpleCrud<Row, Form>
      ...
      renderForm={(f, set) => (
        <div className="space-y-3">
          ...
          <div className="space-y-1"><Label>Conteúdo *</Label><Textarea rows={10} required value={f.conteudo} onChange={e => set({ ...f, conteudo: e.target.value })} placeholder="Olá {{paciente}}, atesto que..." /></div>
