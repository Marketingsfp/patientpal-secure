...
function ContratosPage() {
  ...
  useEffect(() => {
    ...
    if (existing) {
      ...
      void navigate({
        to: "/app/hr-contratos/$id",
        params: { id: "novo" },
        search: { prefillUserId: autoEdit },
      });
    }
    /* eslint-disable-next-line react-hooks/exhaustive-deps */
                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Button
                                ...
                                variant="ghost"
                                onClick={() =>
                                  navigate({ to: "/app/hr-contratos/$id", params: { id: r.id } })
                                }
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <strong>{toDelete?.funcionario_nome}</strong>? Esta ação não pode ser desfeita. O
              login de acesso (se houver) não será removido.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
