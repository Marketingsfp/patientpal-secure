      ...
      columns={[
        {
          key: "chave",
          header: "Chave",
          render: (r) => <code className="text-xs font-mono">{r.chave}</code>,
        },
        {
          key: "valor",
          header: "Valor",
          render: (r) => (
            <span className="text-xs text-muted-foreground">
              {r.valor.slice(0, 4)}••••{r.valor.slice(-2)}
            </span>
          ),
        },
        {
          key: "desc",
          header: "Descrição",
          render: (r) => <span className="text-sm">{r.descricao ?? "—"}</span>,
        },
      ]}
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              type="password"
              value={f.valor}
              onChange={(e) => set({ ...f, valor: e.target.value })}
            />
          </div>
          <div className="space-y-1">
