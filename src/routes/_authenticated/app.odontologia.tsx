  ...
  return (
    <div className="p-6 space-y-6 max-w-6xl mx-auto">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-slate-900 leading-none">Odontologia</h1>
          <p className="text-xs font-medium text-slate-500">Odontograma e prontuário odontológico do paciente.</p>
        </div>
      </div>
