    ...
    <SimpleCrud<Row, Form>
      ...
      columns={[
        ...
        },
        {
          ...
          header: "Mínimo",
          className: "w-24 text-right",
          render: (r) => Number(r.estoque_minimo),
        },
      ]}
      emptyForm={{
        nome: "",
      ...
      toForm={(r) => ({
        ...
        codigo: r.codigo ?? "",
        unidade: r.unidade,
        estoque_atual: String(r.estoque_atual),
      ...
      toPayload={(f) => ({
        ...
        unidade: f.unidade,
        estoque_atual: Number(f.estoque_atual) || 0,
...
<<<<<<< HEAD
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="space-y-1">
              <Label>Código</Label>
              <Input value={f.codigo} onChange={(e) => set({ ...f, codigo: e.target.value })} />
            </div>
          </div>
          <div className="grid grid-cols-4 gap-3">
            <div className="space-y-1">
              <Label>Unidade</Label>
              <Input value={f.unidade} onChange={(e) => set({ ...f, unidade: e.target.value })} />
            </div>
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) => set({ ...f, estoque_atual: e.target.value })}
              />
            </div>
            <div className="space-y-1">
              <Label>Mínimo</Label>
              <Input
                ...
                onChange={(e) => set({ ...f, estoque_minimo: e.target.value })}
              />
            </div>
            <div className="space-y-1">
              <Label>Custo (R$)</Label>
              <CurrencyInput
                ...
                onChange={(v) => set({ ...f, custo_unitario: v })}
              />
            </div>
=======
