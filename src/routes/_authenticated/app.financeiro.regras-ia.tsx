  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div><h1 className="text-xl font-bold text-slate-900 leading-none flex items-center gap-2"><Sparkles className="h-6 w-6 text-primary" />Regras de IA</h1>
          <p className="text-xs font-medium text-slate-500">Categorização automática de lançamentos por padrão</p></div>
