    ...
    <SimpleCrud<Row, Form>
      ...
      columns={[
        { key: "nn", header: "Nosso número", render: (r) => r.nosso_numero ?? "—" },
        {
          ...
          header: "Vencimento",
          className: "w-32",
          render: (r) => new Date(r.vencimento).toLocaleDateString("pt-BR"),
        },
        {
          key: "val",
          header: "Valor",
      ...
      toPayload={(f) => ({
        ...
        nosso_numero: f.nosso_numero || null,
        ...
        <div className="space-y-3">
          <div className="grid grid-cols-3 gap-3">
            <div className="space-y-1">
              <Label>Valor *</Label>
              <CurrencyInput value={f.valor} onChange={(v) => set({ ...f, valor: v })} />
            </div>
            <div className="space-y-1">
              ...
              <Input
                ...
                required
                value={f.vencimento}
                onChange={(e) => set({ ...f, vencimento: e.target.value })}
              />
            </div>
            <div className="space-y-1">
              <Label>Status</Label>
          ...
          <div className="space-y-1">
            ...
            <Input
              value={f.nosso_numero}
              onChange={(e) => set({ ...f, nosso_numero: e.target.value })}
            />
          </div>
          <div className="space-y-1">
            <Label>Linha digitável</Label>
            <Input
              value={f.linha_digitavel}
              onChange={(e) => set({ ...f, linha_digitavel: e.target.value })}
            />
          </div>
          <div className="space-y-1">
