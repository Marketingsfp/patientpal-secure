...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      caixa_mov_tipo:
        "abertura" | "sangria" | "suprimento" | "recebimento" | "despesa" | "fechamento";
      ...
      pagamento_forma:
        ...
        | "outro";
      pagamento_status:
        "pendente" | "autorizado" | "capturado" | "falhou" | "estornado" | "cancelado";
      prestador_tipo:
        "laboratorio" | "clinica_imagem" | "locador_equipamento" | "parceiro_pj" | "outro";
      ...
      tipo_documento: "atestado" | "receita" | "laudo" | "declaracao" | "contrato" | "outro";
      tipo_senha: "N" | "P" | "E" | "R";
    };
    CompositeTypes: {
      [_ in never]: never;
...
export const Constants = {
  public: {
    Enums: {
      ...
      caixa_mov_tipo: ["abertura", "sangria", "suprimento", "recebimento", "despesa", "fechamento"],
      caixa_sessao_status: ["aberto", "fechado"],
      chat_canal_tipo: ["direto", "grupo", "setor"],
      crm_status: ["aberta", "ganha", "perdida"],
      estoque_movimento_tipo: ["entrada", "saida", "ajuste"],
      ...
      pagamento_status: ["pendente", "autorizado", "capturado", "falhou", "estornado", "cancelado"],
      prestador_tipo: [
        "laboratorio",
        "clinica_imagem",
        "locador_equipamento",
