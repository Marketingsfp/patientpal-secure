  ...
  const inner = loading ? (
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <Tabs defaultValue="dados">
        <TabsList
          className={
            asPage ? "grid grid-cols-6 w-full" : "grid grid-cols-6 w-full sticky top-[3.25rem] z-10"
          }
        >
          ...
          <div className="pt-4 border-t space-y-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  As <b>categorias</b> dos serviços selecionados na aba <b>Especialidades</b>{" "}
                  aparecem aqui automaticamente (Consulta, Exame, Procedimento). Defina o tipo e o
                  valor de repasse por categoria — vale para todos os serviços daquela categoria.
                  Use <b>Manual</b> para sobrescrever o repasse de um <b>serviço específico</b>{" "}
