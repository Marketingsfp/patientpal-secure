...
export function ImportarBeneficiariosPage({ produto }: { produto: ProdutoCartao }) {
  ...
  if (!podeEscrever) {
    return (
      <Alert>
        ...
        <AlertDescription>
          Só quem tem permissão de escrita no {rotuloProduto(produto)} pode importar planilhas.
        </AlertDescription>
      </Alert>
    );
  }
