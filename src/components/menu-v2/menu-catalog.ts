...
export const CENTROS: Centro[] = [
  {
    ...
    items: [
      ...
      {
        path: "/app/triagem-enfermagem",
        label: "Triagem",
        icon: Activity,
        modulo: "triagem-enfermagem",
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        path: "/app/financeiro/atendimentos",
        label: "Lançamentos",
        icon: DollarSign,
        modulo: "financeiro",
      },
  ...
  },
  {
    ...
    items: [
      {
        path: "/app/cartao-beneficios/contratos",
        label: "Cartão de Benefícios",
        icon: CreditCard,
        modulo: "cartao-beneficios",
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        path: "/app/exames-resultados",
        label: "Resultados de Exames / Laudos IA",
        icon: FlaskConical,
        modulo: "exames-resultados",
      },
