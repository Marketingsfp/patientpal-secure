...
export function ResumoDoDiaBar({ clinicaId, dataRef, filtroMedico, medicoNome, onFechar }: Props) {
  ...
  return (
    <div className="mb-2 tela-alta:mb-3 rounded-xl border border-slate-200 bg-card px-3 py-2 tela-alta:py-2.5 shadow-xs">
      <div className="mb-1.5 tela-alta:mb-2 flex flex-wrap items-center justify-between gap-2">
