    ...
    <div className="flex items-center justify-center min-h-[60vh] p-6">
      <Card className="max-w-md w-full">
        ...
        <CardContent className="text-sm text-muted-foreground text-center space-y-4">
          ...
          <p>
            Se você precisa desse acesso, fale com o administrador da clínica para ajustar as
            permissões em <span className="font-medium">Perfis de acesso</span>.
          </p>
          <div className="flex justify-center pt-2">
            <Button type="button" variant="default" onClick={() => navigate({ to: "/app" })}>
