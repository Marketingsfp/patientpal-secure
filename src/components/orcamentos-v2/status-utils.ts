...
export type DerivedStatus = "aberto" | "aprovado" | "convertido" | "expirado" | "cancelado";
...
export function deriveStatus(o: OrcV2): DerivedStatus {
  ...
  if (o.aprovado) return "aprovado";
  return "aberto";
}

export const STATUS_META: Record<DerivedStatus, { label: string; dot: string; badge: string; border: string }> = {
  aberto:     { label: "Aberto",     dot: "bg-amber-500",  badge: "bg-amber-100 text-amber-900 border-amber-300 dark:bg-amber-900/30 dark:text-amber-200 dark:border-amber-800", border: "border-l-amber-500" },
  aprovado:   { label: "Aprovado",   dot: "bg-sky-500",    badge: "bg-sky-100 text-sky-900 border-sky-300 dark:bg-sky-900/30 dark:text-sky-200 dark:border-sky-800",             border: "border-l-sky-500" },
  convertido: { label: "Convertido", dot: "bg-emerald-500",badge: "bg-emerald-100 text-emerald-900 border-emerald-300 dark:bg-emerald-900/30 dark:text-emerald-200 dark:border-emerald-800", border: "border-l-emerald-500" },
  expirado:   { label: "Expirado",   dot: "bg-red-500",    badge: "bg-red-100 text-red-900 border-red-300 dark:bg-red-900/30 dark:text-red-200 dark:border-red-800",             border: "border-l-red-500" },
  cancelado:  { label: "Cancelado",  dot: "bg-zinc-500",   badge: "bg-zinc-200 text-zinc-800 border-zinc-300 dark:bg-zinc-800 dark:text-zinc-200 dark:border-zinc-700",         border: "border-l-zinc-500" },
};
