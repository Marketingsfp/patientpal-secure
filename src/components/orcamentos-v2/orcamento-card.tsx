...
export function pagadorLabel(
  forma: string | null,
): "Particular" | "Associado" | "Cartão de Benefícios" {
          ...
          {!compact && (
            <>
              <div className="flex flex-wrap items-center gap-2 mt-1 text-xs text-muted-foreground">
                <span>
                  {o.itens_total || 0} {o.itens_total === 1 ? "proc." : "procs."}
                </span>
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <Button
              ...
              title="Converter em pagamento"
              data-testid="card-converter"
            >
