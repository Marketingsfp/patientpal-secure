    ...
    <div className="rt-shell border rounded-md overflow-hidden bg-background">
      <div className="flex flex-wrap items-center gap-1 border-b p-1.5 bg-muted/30 print:hidden">
        ...
        <input
          ref={docRef}
          type="file"
          accept=".docx,.pdf,.txt,.html,.htm,application/pdf,text/plain,text/html,application/vnd.openxmlformats-officedocument.wordprocessingml.document"
          className="hidden"
          onChange={async (e) => {
      ...
      <div className="rt-scroll bg-muted/40 overflow-auto" style={{ maxHeight: "70vh" }}>
        {htmlMode ? (
          ...
          <div className="mx-auto my-4" style={{ width: "210mm" }}>
            ...
            <div
              className="rt-page print-document bg-card shadow-md"
              style={{
                width: "210mm",
                minHeight: "297mm",
                position: "relative",
