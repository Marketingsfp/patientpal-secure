...
export function CuboBI({ clinicaId, ini, fim }: { clinicaId?: string; ini: string; fim: string }) {
  ...
  function salvarView() {
    ...
    try {
      ...
      // localStorage pode estar cheio ou bloqueado (modo privativo): a
      // visualização segue salva em memória nesta sessão.
    }
  ...
  function excluirView(name: string) {
    ...
    try {
      ...
      // Persistência é best-effort; a remoção já valeu no estado da tela.
    }
  }
