...
## Fila
- [ ] Aplicar a migração do relatório "Marcações por atendente" exatamente como enviada (índice + `rel_marcacoes_por_atendente`)
...
- [ ] Adiantamento: opção "já pagou adiantado" na cobrança (dialog, confirmação, rastro)
- [ ] Adiantamento: mensagem da agenda ensinando as duas saídas
- [ ] Adiantamento: migração do texto da trava `fn_agendamento_exige_pagamento`
