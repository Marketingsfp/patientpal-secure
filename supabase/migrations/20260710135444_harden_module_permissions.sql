...
with modules(modulo) as (
  ...
  ('recepcao', '{"agenda":"write","recepcao":"write","clientes":"write","fluxo":"write","orcamentos":"write","consulta-rapida":"read","perfil-proprio":"write","checkin":"write","painel":"write","chat":"write","cartao-beneficios":"read","caixa":"write","procedimentos":"read","nfse":"write","atendimento-multiplo":"write","tipos-servico":"read"}'::jsonb),
  ('caixa', '{"caixa":"write","clientes":"read","recepcao":"read","financeiro":"read","consulta-rapida":"read","perfil-proprio":"write","boletos":"write","nfse":"write","contratos":"read","cartao-beneficios":"read","chat":"write"}'::jsonb),
