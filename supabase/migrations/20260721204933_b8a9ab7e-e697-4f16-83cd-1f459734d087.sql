...
BEGIN
  ...
  INSERT INTO public.contrato_renovacoes (
    ...
    valor_anterior, valor_novo, parcelas_geradas,
    periodo_inicio, periodo_fim, observacao, usuario_id
  ) VALUES (
    v_contrato.clinica_id, _contrato_id, v_novo_id, 'troca_convenio',
    v_contrato.convenio_id, _convenio_novo_id,
    COALESCE(v_contrato.valor_mensal, 0), v_valor, v_num_parcelas,
    v_data_inicio, v_periodo_fim, _observacao, auth.uid()
  );
