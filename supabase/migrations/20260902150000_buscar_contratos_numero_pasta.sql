-- Tela de Contratos: seguir a mesma ordem de prontuario da guia impressa.
--
-- ================================ CONTEXTO =================================
-- A funcao devolvia o prontuario como COALESCE(historico, interno). Em
-- 02/09/2026 a ordem de exibicao do sistema passou a colocar o numero da pasta
-- fisica na frente do historico (src/lib/prontuario.ts, prontuarioExibicao) --
-- a guia da paciente VANILDA DOS SANTOS VENTURA saia com 194897 quando a pasta
-- dela e 1348, e 194897 e o numero interno de OUTRA paciente.
--
-- Sao 3.693 pacientes com pasta cadastrada divergindo do historico. Sem esta
-- migration a lista de Contratos mostraria o historico enquanto a guia impressa
-- mostra a pasta, e o mesmo paciente apareceria com dois numeros diferentes
-- dependendo da tela.
--
-- ================================ A MUDANCA ================================
-- Uma unica expressao muda: `numero_pasta` entra na frente do historico.
-- Assinatura, colunas, tipos e ordem continuam iguais -- a tela nao precisa de
-- ajuste. A BUSCA nao muda: ela ja comparava as tres colunas separadamente,
-- entao digitar qualquer um dos numeros continua achando o contrato.
