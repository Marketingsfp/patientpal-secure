UPDATE public.cb_convenios SET modelo_contrato = $tpl$<div style="font-family:'Times New Roman',Times,serif;font-size:11pt;line-height:1.45;color:#000;max-width:210mm;margin:0 auto;padding:16mm 14mm;">
...
<p style="text-align:justify;"><b>Parágrafo primeiro:</b> As partes concordam que a coleta e tratamento de dados, sempre que possível e recomendável, observará o consentimento do cliente no fornecimento de dados, que deverá ser livre, informado, inequívoca e relacionado a uma determinada finalidade, o que será feito mediante aditivos e termos específicos, de acordo com a necessidade e/ou obrigação legal de coleta de dados, conforme o ANEXO I.</p>
...
<div style="text-align:right;font-size:9pt;color:#555;margin-top:20px;">6/6</div></div>$tpl$, updated_at = now() WHERE id = '4fdce541-5b2b-4816-ba7d-911b36741b7d';