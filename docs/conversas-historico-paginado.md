# Histórico das conversas: lotes de quinze

A Inbox abre com os quinze registros mais recentes, contando mensagens de paciente,
Nina, atendentes, marcadores do sistema e eventos internos na mesma paginação.
O agrupamento visual dos eventos continua valendo: quinze registros podem formar
menos de quinze balões. Notas do contato e o resumo da Nina são painéis separados.

Ao subir e chegar a até 100 px do início, a tela busca mais quinze registros.
...
Cada fonte retorna no máximo dezesseis candidatos; o servidor combina a ordem,
devolve quinze registros e indica se há mais. O navegador recebe somente esse
lote, sem baixar o histórico completo para cortá-lo visualmente. O mesmo limite
vale para o pré-carregamento ao apontar um card e para reabrir uma conversa em
cache. Não consulta contagem total e não
...
em páginas de quinze, até recuperar a lacuna. O cache reabre só a janela recente;
