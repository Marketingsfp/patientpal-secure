...
const Equip: React.FC<{
  ...
  return (
    ...
    >
      ...
      <div>
        <div style={{ fontFamily: inter.fontFamily, fontSize: 22, fontWeight: 500, opacity: 0.6 }}>
          {label}
        </div>
        <div style={{ display: "flex", alignItems: "baseline", gap: 6 }}>
          ...
          <span
            style={{ fontFamily: inter.fontFamily, fontSize: 24, color: theme.ink, opacity: 0.6 }}
          >
            {unidade}
          </span>
        </div>
      ...
      <FadeSlide delay={20} from="left">
        <div
          style={{
            ...
            borderRadius: 24,
            maxWidth: 1100,
            borderLeft: `12px solid ${theme.red}`,
            transform: `scale(${beep})`,
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 12 }}>
            ...
            >
              ALERTA · ENFERMEIRA IA
            </span>
          </div>
          <p style={{ fontFamily: inter.fontFamily, fontSize: 30, lineHeight: 1.4, margin: 0 }}>
            <strong>Maria S., 58 anos</strong> — PA 162/104 mmHg + HGT 248 mg/dL.
            <br />
