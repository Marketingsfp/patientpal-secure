      ...
      <AbsoluteFill style={{ padding: "0 150px", justifyContent: "center" }}>
        ...
        <Rise delay={40} y={30}>
          <div style={{ fontFamily: body, color: C.creamDim, fontSize: 34, maxWidth: 1200 }}>
            Serve para o paciente que não veio na migração do sistema antigo — recebe na hora, sem
            segurar a fila do caixa.
          </div>
        </Rise>
      </AbsoluteFill>
      <AbsoluteFill
        style={{
          background: `radial-gradient(720px 420px at 78% 78%, ${C.clay}${Math.round(glow * 90)
            .toString(16)
