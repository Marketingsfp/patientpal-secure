...
export const AgendaScenePagamento: React.FC = () => {
  ...
  const cx = interpolate(f, [0, 22, 60, 110], [1500, 1450, 1100, 1100], {
      ...
      >
        {[
          ...
          <div
            ...
            style={{
              display: "grid",
              gridTemplateColumns: "100px 1fr 160px 60px",
              padding: "16px 12px",
              borderTop: i === 0 ? "none" : `1px solid ${C.line}`,
              alignItems: "center",
              borderRadius: 10,
              background: r.hl ? "rgba(29,78,216,.06)" : "transparent",
            }}
          >
            ...
            <div style={{ textAlign: "right" }}>
              <div
                style={{
                  ...
                  height: 36,
                  borderRadius: 10,
                  background: r.paid ? "rgba(16,185,129,.15)" : "#F2F4F9",
                  display: "inline-flex",
                  alignItems: "center",
      ...
      {openDialog && (
        ...
        >
          ...
          <div style={{ fontSize: 17, color: C.sub, marginTop: 4 }}>
            Maria Souza · Consulta Cardiológica
          </div>
          ...
          >
            ...
            <span style={{ fontSize: 30, fontWeight: 800, fontFamily: dm, color: C.primary }}>
              R$ 250,00
            </span>
          </div>
          ...
          <div style={{ marginTop: 18 }}>
            ...
            >
              {processing
                ? "Processando…"
                : done
                  ? "Pagamento aprovado · recibo enviado"
