      ...
      >
        ...
        <div
          style={{
            ...
            alignItems: "center",
            justifyContent: "center",
            boxShadow: "0 20px 60px rgba(16,185,129,.5)",
          }}
        >
          <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="3">
            <path d="M5 12l5 5L20 7" />
          </svg>
        </div>
      </div>
      <div
        style={{ textAlign: "center", opacity: s2, transform: `translateY(${(1 - s2) * 16}px)` }}
      >
        <div
          style={{
            color: "#fff",
        ...
        <div
          style={{ color: "rgba(255,255,255,.7)", fontSize: 28, marginTop: 12, fontFamily: inter }}
        >
