...
export const AgendaSceneLote: React.FC = () => {
  ...
  const cx = interpolate(f, [0, 18, 30, 42, 60, 78, 115], [1500, 220, 220, 220, 1500, 1100, 1100], {
    extrapolateRight: "clamp",
  });
  const cy = interpolate(f, [0, 18, 30, 42, 60, 78, 115], [800, 320, 400, 480, 760, 540, 540], {
    extrapolateRight: "clamp",
  });
    ...
    <Frame title="Agendas" step="Pagamento em lote — vários pacientes">
        ...
        {ROWS.map((r, i) => {
          ...
          return (
            <div
              ...
              style={{
                display: "grid",
                gridTemplateColumns: "44px 100px 1fr 1fr 120px",
                padding: "16px 12px",
      ...
      {openDialog && (
        ...
        >
          ...
          <div style={{ fontSize: 16, color: C.sub, marginTop: 4 }}>
            3 atendimentos · mesmo recebedor
          </div>
          ...
          <div style={{ marginTop: 16 }}>
            {ROWS.slice(0, 3).map((r, i) => (
              ...
              >
                ...
                <span style={{ fontFamily: dm, fontWeight: 600 }}>
                  R$ {r.v.toFixed(2).replace(".", ",")}
                </span>
              </div>
            ))}
      ...
      {done && (
        ...
        >
          3 pagamentos · R$ {total},00 recebidos
        </div>
      )}
