          ...
          {HORARIOS.map((h, i) => {
            ...
            return (
              ...
              >
                ...
                {isSwapped && (
                  <span
                    style={{ marginLeft: "auto", fontSize: 14, color: "#065f46", fontWeight: 600 }}
                  >
                    ✓ AGENDADO
                  </span>
                )}
        ...
        {f > 55 && (
          <div
            style={{
              ...
              borderRadius: 16,
              padding: 24,
              opacity: dialogSpring,
              transform: `translateY(${(1 - dialogSpring) * 16}px)`,
          ...
          >
            ...
            <div
              style={{
                background: swap ? "#10b981" : C.primary,
                color: "#fff",
                padding: "12px 18px",
                borderRadius: 10,
                fontSize: 18,
