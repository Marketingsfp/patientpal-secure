    ...
    <Frame title="Agendas" step="Histórico do paciente">
      ...
      {openPanel && (
        ...
        >
          ...
          <div style={{ fontSize: 18, color: C.sub, marginBottom: 18, fontFamily: dm }}>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    marginBottom: 14,
                    opacity: itemS,
                    transform: `translateY(${(1 - itemS) * 8}px)`,
                  }}
                >
                  <div
                    style={{
                      ...
                      height: 14,
                      borderRadius: 999,
                      background: it.st === "Faltou" ? "#ef4444" : C.accent,
                      border: "3px solid #fff",
                      boxShadow: `0 0 0 2px ${it.st === "Faltou" ? "#ef4444" : C.accent}`,
                    }}
                  />
                  <div
                    style={{
                      ...
                      padding: "12px 16px",
                      display: "grid",
                      gridTemplateColumns: "110px 1fr 160px 100px",
                      alignItems: "center",
                      gap: 10,
                    }}
                  >
                    <div style={{ fontSize: 16, color: C.sub, fontFamily: dm, fontWeight: 600 }}>
                      {it.d}
                    </div>
                    <div>
                    ...
                    <div style={{ fontSize: 17, fontFamily: dm, fontWeight: 700, color: C.ink }}>
                      {it.v}
                    </div>
                    <div
                      style={{
                        ...
                        borderRadius: 999,
                        background:
                          it.st === "Faltou" ? "rgba(239,68,68,.15)" : "rgba(16,185,129,.18)",
