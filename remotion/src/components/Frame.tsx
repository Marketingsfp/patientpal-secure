...
export const Frame: React.FC<{ title: string; step: string; children: React.ReactNode }> = ({
  title,
  step,
  children,
}) => {
    ...
    <AbsoluteFill style={{ padding: 80, opacity: s }}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div style={{ color: "#fff", fontSize: 28, fontWeight: 600, fontFamily: dm }}>
            ClinicaOS
          </div>
          <div style={{ color: "rgba(255,255,255,.5)", fontSize: 20, marginLeft: 12 }}>
            / {title}
          </div>
        </div>
        <div
