  ...
  return (
    <AbsoluteFill>
      ...
      <AbsoluteFill style={{ padding: "90px 140px" }}>
        ...
        >
          {MESES.map((m, i) => {
            const op = interpolate(frame, [18 + i * 6, 30 + i * 6], [0, 1], {
            ...
            return (
              <div
                ...
                style={{
                  opacity: op,
                  transform: `translateY(${interpolate(op, [0, 1], [22, 0])}px)`,
                  borderRadius: 20,
                  padding: "20px 14px",
                  textAlign: "center",
              ...
              >
                <div
                  style={{ fontFamily: body, color: C.creamDim, fontSize: 20, letterSpacing: 2 }}
                >
                  {i + 1}/12
                </div>
                <div
        ...
        <Rise delay={96} y={26}>
          <div style={{ fontFamily: body, color: C.creamDim, fontSize: 30, maxWidth: 1500 }}>
            A parcela do mês de referência já entra{" "}
            <span style={{ color: C.cream, fontWeight: 700 }}>paga</span>, ligada ao caixa, e a GR
            sai para impressão. O paciente passa a aparecer na aba de Convênio.
          </div>
        </Rise>
      </AbsoluteFill>
    </AbsoluteFill>
