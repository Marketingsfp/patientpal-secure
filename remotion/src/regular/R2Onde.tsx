    ...
    <AbsoluteFill>
      ...
      <AbsoluteFill style={{ padding: "100px 140px" }}>
        ...
        <div style={{ display: "flex", gap: 24, flexWrap: "wrap" }}>
          {LOCAIS.map((l, i) => {
            const op = interpolate(frame, [16 + i * 10, 30 + i * 10], [0, 1], {
        ...
        <Panel delay={62} style={{ maxWidth: 1440 }}>
          <div style={{ fontFamily: body, color: C.creamDim, fontSize: 30, lineHeight: 1.5 }}>
            Busque o paciente pelo nome ou prontuário. Se ele já tiver contrato ativo, as parcelas
            em aberto aparecem na hora — é só clicar em{" "}
            <span style={{ color: C.cream, fontWeight: 700 }}>Receber</span>.
          </div>
        </Panel>
      </AbsoluteFill>
    </AbsoluteFill>
