  ...
  return (
    <AbsoluteFill>
      ...
      <AbsoluteFill style={{ padding: "150px 140px", justifyContent: "center" }}>
        ...
        <div style={{ height: 26 }} />
        <Rise delay={8} y={50}>
          <div style={{ fontFamily: display, color: C.cream, fontSize: 104, fontWeight: 700, lineHeight: 1.03, maxWidth: 1480 }}>
            Pagamento avulso agora
            <br />
            regulariza o contrato
          </div>
        </Rise>
        <div style={{ height: 30, width: 620 * line, borderBottom: `6px solid ${C.clay}`, marginTop: 28 }} />
        <div style={{ height: 28 }} />
        <Rise delay={40} y={26}>
